...
import com.taikang.common.utils.CodecUtils;
...
public class UserServiceImpl implements UserService {
    ...
    private static final String KEY_PREFIX2 = "taikang:user:info";
    ...
    public Boolean sendVerifyCode(String phone) {
        ...
        try {
            ...
            msg.put("code",code);
            //2.发送短信
            this.amqpTemplate.convertAndSend("taikang.sms.exchange","sms.verify.code",msg);
